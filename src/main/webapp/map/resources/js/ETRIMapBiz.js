...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd"
  >
<sld:NamedLayer>
  <sld:Name>WS</sld:Name>
  <sld:UserStyle>
    <sld:Name>WS</sld:Name>
    <sld:Title>WS</sld:Title>
    <sld:Abstract>WS</sld:Abstract>
    <FeatureTypeStyle>
      <Rule>
        <Name>WS 0.0</Name>
        <Title>WS 2.0</Title>
        <ogc:Filter>
          <ogc:And>
            <ogc:PropertyIsGreaterThanOrEqualTo>
              <ogc:PropertyName>WS</ogc:PropertyName>
              <ogc:Literal>0.0</ogc:Literal>
            </ogc:PropertyIsGreaterThanOrEqualTo>
            <ogc:PropertyIsLessThan>
              <ogc:PropertyName>WS</ogc:PropertyName>
              <ogc:Literal>2.001</ogc:Literal>
            </ogc:PropertyIsLessThan>
          </ogc:And>
        </ogc:Filter>
        <PointSymbolizer>
         <Graphic>
           <ExternalGraphic>
             <OnlineResource
               xlink:type="simple"
               xlink:href="images/wind_24x24_01.png" />
             <Format>image/png</Format>
           </ExternalGraphic>
           <Size>24</Size>
           <Rotation><ogc:PropertyName>WD</ogc:PropertyName></Rotation>
         </Graphic>
       </PointSymbolizer>
      </Rule>
	  <Rule>
